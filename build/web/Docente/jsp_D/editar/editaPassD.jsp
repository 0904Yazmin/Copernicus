        ...
        <form name="datosEdit" action="actualizarPass.jsp" method="post">
            <div id="cuadro4" style="background-color: white; color: black;">
                <table class="tablita" border="0">
                    ...
                    <tr>
                        <td><input id="pass" type="text" name="pass"  class="actu" value="" required></td>
                    </tr>
                    <tr>
                        <td>Nueva contraseña</td>
                    </tr>
                    <tr>
                        <td><input id="passNew" type="password" name="passNew"  class="actu" value="" required></td>
                    </tr>
                    <tr>
                        <td>Confirmar nueva contraseña </td><td>
                    </tr>
                    <tr>
                        <td><input id="passConfirm" type="password" name="passConfirm"  class="actu" value="" required></td>
                    </tr>
                    <tr>
