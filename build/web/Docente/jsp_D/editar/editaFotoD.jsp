...
<%
    ...
    try {
        ...
        base.conectar();
        String strQry = "select * from Docente where id_docen='" + id + "'";
...
<html>
    ...
    <body id="Principal">
        <form name="datosEdit" action="guardar_img.jsp" method="post" enctype="MULTIPART/FORM-DATA">
            <div id="cuadro4" style="background-color: white; color: black; padding: 22px;">
                <table class="tablita" border="0" style="color: black;">
                    ...
                    <tr>
                        ...
                        %>
                        <td><img class="imagenUsuCero" src="../../../General/Usu_img/fotosPerfil/<%=info.getString(5)%>" width="135" height="135"></td>
                    ...
                    <tr>
                        <td><input id="fileImg" type="file" name="fileImg"  class="fileImg" accept="image/*" required></td>
                    </tr>
