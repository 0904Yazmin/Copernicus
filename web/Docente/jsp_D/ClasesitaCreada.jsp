...
<%
    ...
    BD basesita = new BD();
    basesita.conectar();
    String strQry = "Select max(id_clase) from Clases where id_docen ='" + idPersona + "'"; //seleccionar la ultima clase creada por el docente de la tabla Clases
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css_D/newClass.css" ><!--  -->
        <style>
